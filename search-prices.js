export default async function handler(req, res) {
  // Configurar CORS por si se prueba en desarrollo local
  ...
  // 1. Consultar Mercadona online (código postal 29001 Málaga)
  try {
    ...
    console.error('Error Mercadona API:', err);
  }

  // 2. Consultar Open Prices (para Carrefour y Lidl en España)
  try {
    ...
    console.error('Error Open Prices API:', err);
  }
